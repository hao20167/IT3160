...
import copy
from util.graph import get_test_contrast_curve_high_level
from util.episode_selector import start_selector, get_transformation_exp
import re
...
parser.add_argument(
    "--valid_data_path",
    type=str,
    default="data/BTCUSDT/final/valid.feather",
    help="the number of hidden_nodes",
)
...
parser.add_argument(
    "--test_data_path",
    type=str,
    default="data/BTCUSDT/final/test.feather",
    help="the number of hidden_nodes",
)
...
class trader(object):
    def __init__(self, args) -> None:
        ...
        self.high_level_tech_indicator_list = np.load(
            "data/BTCUSDT/feature_analysis/2024-12-17_2025-01-02/minute_feature.npy"
        ).tolist()
        self.low_level_tech_indicator_list = np.load(
            "data/BTCUSDT/feature_analysis/2024-12-17_2025-01-02/second_feature.npy"
        ).tolist()
