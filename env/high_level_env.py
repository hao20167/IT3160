...
from util.net import Qnet

high_level_tech_indicator_list = np.load("data/BTCUSDT/feature_analysis/2024-12-17_2025-01-02/minute_feature.npy").tolist()
low_level_tech_indicator_list = np.load("data/BTCUSDT/feature_analysis/2024-12-17_2025-01-02/second_feature.npy").tolist()
...
if __name__ == "__main__":
    df = pd.read_feather("data/BTCUSDT/final/valid.feather")
    reward_list = []
