...
tech_indicator_list = np.load("data/BTCUSDT/feature_analysis/2024-12-17_2025-01-02/second_feature.npy").tolist()
...
if __name__ == "__main__":
    data_path = "data/BTCUSDT/final/train/df_83.feather"
